          ...
          <div className="mt-8">
            ...
            <div className="mt-2 flex justify-end border-t border-gray-100 pt-8">
              <div className="w-screen max-w-full space-y-4 ">
                <dl className="space-y-1 text-sm text-gray-700 border-y-2 divide-y divide-gray-300">
                  ...
                  {/* maybe i will add this feature after basic functionality is done */}
                  <div className="flex justify-between">
                    <dt>Discount</dt>
                    <dd>-£0</dd>
                  </div>
                ...
                {/* maybe i will add this feature after basic functionality is done */}
                <div className="flex justify-end ahidden">
